...
// File generated on 20.02.2012 16:34:56 from Type Library described below.
...
procedure TXSLTemplate60Properties.Set_stylesheet(const stylesheet: IXMLDOMNode);
begin
  DefaultInterface.Set_stylesheet(stylesheet);
end;
...
procedure TSAXXMLReader60Properties.Set_entityResolver(const oResolver: IVBSAXEntityResolver);
begin
  DefaultInterface.Set_entityResolver(oResolver);
end;
...
procedure TSAXXMLReader60Properties.Set_contentHandler(const oHandler: IVBSAXContentHandler);
begin
  DefaultInterface.Set_contentHandler(oHandler);
end;
...
procedure TSAXXMLReader60Properties.Set_dtdHandler(const oHandler: IVBSAXDTDHandler);
begin
  DefaultInterface.Set_dtdHandler(oHandler);
end;
...
procedure TSAXXMLReader60Properties.Set_errorHandler(const oHandler: IVBSAXErrorHandler);
begin
  DefaultInterface.Set_errorHandler(oHandler);
end;
